		...
		var junctions = [
			new Mind.AfferentJunction(this, function() {
				if (this.bodyPart.wall != null) {
					var rightEdge = this.bodyPart.body.GetWorldPoint(
						new b2Vec2(width / 2, 0)
					)
					var wallLeftEdge = this.bodyPart.wall.body.GetWorldPoint(
						new b2Vec2(-this.bodyPart.wall.width / 2, 0)
					)
