...
var testWall = new Wall.BasicWall(
	worldWidth - worldWidth / 40,
	worldHeight / 2,
	worldWidth / 20,
	worldHeight
)
...
var data
var testGenerator = new Generator(0.5)
...
var makeButtons = function() {
	...
	var playPauseButtonText = new PIXI.Text('Play', {
		font: METER + 'px Arial',
		fill: 'white',
	})
	...
	var evolveButtonText = new PIXI.Text('Evolve', {
		font: METER + 'px Arial',
		fill: 'white',
	})
	...
	var timeButtonText = new PIXI.Text('1x', {
		font: METER + 'px Arial',
		fill: 'white',
	})
...
function animate() {
	...
	world.Step(
		...
		Math.ceil(10 * timeAccelerationFactor),
		Math.ceil(10 * timeAccelerationFactor)
	)
	creatures.forEach(function(creature, index, arr) {
